...
export const MonthlyAttendancePdfReport = forwardRef<HTMLDivElement, PdfReportProps>(
  ({ monthYear, totalWorkingDays, totalHours, data }, ref) => {
    return (
      <div 
        ref={ref} 
        style={{
      ...
      >
        ...
        <div style={{ textAlign: 'center', marginBottom: '20px', borderBottom: '2px solid black', paddingBottom: '10px', position: 'relative' }}>
          ...
          <div style={{ paddingLeft: '90px' }}>
            ...
            <h3 style={{ fontSize: '14px', margin: '0', fontWeight: 'normal' }}>
              REKAPITULASI PERSENTASI KEHADIRAN PEGAWAI NEGERI SIPIL / CALON PEGAWAI NEGERI SIPIL
            </h3>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '40px', fontSize: '14px' }}>
          ...
          <div style={{ textAlign: 'center', width: '300px' }}>
            <p style={{ marginBottom: '80px' }}>Kepala Dinas Komunikasi dan Informatika</p>
            <p style={{ margin: 0, fontWeight: 'bold', textDecoration: 'underline' }}>HAIRUL ANWAR, S.Kom.</p>
            <p style={{ margin: 0 }}>NIP. 196912312001121019</p>
          </div>
        </div>
      </div>
    );
